...
<section class="p-strip--image is-light" style="background-image:url("https://assets.ubuntu.com/sites/ubuntu/latest/u/img/backgrounds/image-background-paper.png")">
  <div class="row u-vertically-center">
    <div class="col-8">
      ...
      <p>Ubuntu Local Communities, often shortened to LoCos, are regional teams that help advocate, promote, translate, develop and otherwise improve Ubuntu.</p>
      <p>Find a Local Communty your region or start your own!</p>
    </div>
    <div class="col-4 u-hide--small u-align--center">
      <img src="https://ubuntucommunity.s3.dualstack.us-east-2.amazonaws.com/original/3X/1/3/139ae23314628be12a20c97669e7a21e1f8f5c04.png" alt="">
    </div>
  </div>
</section>
<div class="row">
...
<div class="p-modal" id="modal">
  <section class="p-modal__dialog" role="dialog" aria-modal="true" aria-labelledby="modal-title" aria-describedby="modal-description">
    <header class="p-modal__header">
      <h2 class="p-modal__title" id="modal-title">' . $locos["name"] . '</h2>
