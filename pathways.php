<?php
// Pull category JSON Decode
$toc_json = file_get_contents('https://discourse.ubuntu.com/categories.json?include_subcategories=true');
...
<section class="p-strip is-deep">
  <div class="row u-vertically-center">
    <div class="col-8">
      <h2>Learning begins by taking the first step</h2>
      <p>Start your journey to becomming an Ubuntu contributor by following our fun and informative <strong>Pathways</strong> written by members of the Ubuntu community.</p>
      <button class="p-button--brand">Explore Pathways</button>
    </div>
    <div class="col-4 u-hide--small u-align--center">
      <img src="img/pathways.png" alt="">
    </div>
  </div>
</section>
...
<div class="p-heading-icon">
  <div class="p-heading-icon__header">
    <img class="p-heading-icon__img" src="https://assets.ubuntu.com/v1/41b27713-ubuntu-logo.png" alt="">
    <h3 class="p-heading-icon__title">Starter Pathways</h3>
  </div>
  <p>Not sure where your skills fit in? Try one of these exciting pathways.</p>
</div>
